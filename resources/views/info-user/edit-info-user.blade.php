...
<section class="content">
  <div class="row">
    <div class="col-xs-12">
	    ...
	    {!! Form::model($infoUser, array('route' =>array('info-users.update',$infoUser->id),'method'=>'PUT','id'=>'infoUserForm')) !!}

            <div class="box-header with-border">
                <h3 class="box-title"> Editer Info Utilisateur {{$infoUser->nom}} </h3>
            </div>
            <div class="box-body">
